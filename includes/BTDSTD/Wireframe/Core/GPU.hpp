...
namespace Wireframe::Device
{
	...
	struct GPU
	{
		...
		inline bool Create(GPU_CreateInfo& info, Window::DesktopWindow* window)
		{
			...
			// Initialize Volk and Vulkan Instance
			...
			selector.set_minimum_version(info.vulkanMajorVersion, info.vulkanMinorVersion)
			...
			// Load device-specific Vulkan function pointers
